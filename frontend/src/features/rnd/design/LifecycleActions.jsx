...
function DialogHint({ action, design, fin }) {
  ...
  if (action === "submit_final") return box(fin.complete ? "bg-[#EAF7EF] text-[#1A7A3A]" : "bg-[#FDF3F2] text-[#C62828]", <>
    Varian warna {fin.colorway_files}/{fin.colorway_required} · Mockup {fin.mockup_files}/1.{fin.complete ? " Lengkap — siap diserahkan." : " Belum lengkap — unggah dulu di tab Final."}</>, "design-submit-final-check");
